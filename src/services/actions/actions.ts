...
export const CLEAR_UUID_INGREDIENTS: 'CLEAR_UUID_INGREDIENTS' = 'CLEAR_UUID_INGREDIENTS'
...
export const addIngredientAction = (payload: TIngredient): IAddIngredients => ({ type: ADD_INGREDIENTS, payload })
export const getIngredientsAction = (payload: Array<TIngredient>): ISetIngredients => ({ type: SET_INGREDIENTS, payload })
export const postOrderAction = (payload: string): IGetOrder => ({ type: GET_ORDER, payload })
export const postForgotPasswordAction = (payload: string): IForgotPassword => ({ type: FORGOT_PASSWORD, payload })
export const postResetPasswordAction = (payload: string): IResetPassword => ({ type: RESET_PASSWORD, payload })
export const postRegisterAction = (payload: object): IRegisterUser => ({ type: REGISTER_USER, payload })
export const postAuthAction = (payload: object): IAuthUser => ({ type: AUTH_USER, payload })
export const getAuthUserDataAction = (payload: object): IAuthUserData => ({ type: AUTH_USER_DATA, payload })
