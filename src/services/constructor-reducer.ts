import { ADD_INGREDIENTS, DRAG_INGREDIENT, REMOVE_INGREDIENT, TActions } from "./actions/actions";
...
export const burgerConstructorReducer = (state = defaultBurgerConstructor, action: TActions): TDefaultBurgerConstructor => {
    switch (action.type) {
